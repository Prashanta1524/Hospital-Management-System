...
#     # Initialising the actors
    ...
    while running:
        ...
        print(' 6- Print all Doctors Details')
        print(' 7- Print all Patients Details')
        print(' 8- Print all Patients with same surname')
        print(' 9- Get Report')
        print(' 10- Quit')
        ...
        #ToDo1
            ...
            admin.print_doctor_details(doctors)

        elif op == '7':
            admin.print_patient_details(patients)

        elif op == '8':
            grouped_patients = admin.group_patients(patients)
            for surname, patients_with_surname in grouped_patients.items():
...
#         self.root.configure(bg="#d2ff0a")

# # Heading Label
#         label_heading = tk.Label(self.root, text="Admin", font=("Arial", 20, "bold"), bg="#d2ff0a", fg="black")
#         label_heading.pack(pady=15)

# # Username Label and Entry
#         label_username = tk.Label(self.root, text="Username:", font=("Arial", 12), bg="#d2ff0a", fg="black")
#         label_username.pack(pady=5)
#         self.entry_username = tk.Entry(self.root, font=("Arial", 12),bd=0)
#         self.entry_username.pack()
        
# # Password Label and Entry
#         label_password = tk.Label(self.root, text="Password:", font=("Arial", 12), bg="#d2ff0a", fg="black")
...
#         root.configure(bg="#d2ff0a")  # Set background color
...
# # Create label
#         label = tk.Label(root, text="Choose an operation", font=label_font, bg="#d2ff0a")
#         label.pack(pady=20)

# # Create buttons for each option
#         for option, method in options:
#             button = tk.Button(root, text=option, font=button_font, bg="#b89421", fg="white", padx=10, pady=5, command=method,width=40,bd=0)
#             button.pack(pady=5)
#         root.mainloop()
...
#         Admin.generate_management_report(self.doctors,self.patients)
#         self.look_terminal()
...
# # Create label
#         label = tk.Label(root, text="Choose an operation:", font=label_font, bg="#d2ff0a",bd=0)
#         label.pack(pady=20)

# # Create buttons with modern design and colors
#         button1 = tk.Button(root,bd=0, text=" 1 - Register Doctor",width=25, font=button_font, bg="#b89421", fg="white", padx=10, pady=5, command=self.method1)
#         button1.pack(pady=10)

#         button2 = tk.Button(root,bd=0, text=" 2 - View All Doctors",width=25, font=button_font, bg="#b89421", fg="white", padx=10, pady=5, command=self.method2)
#         button2.pack(pady=10)

#         button3 = tk.Button(root,bd=0, text=" 3 - Update Doctor",width=25, font=button_font, bg="#b89421", fg="white", padx=10, pady=5, command=self.method3)
#         button3.pack(pady=10)

#         button4 = tk.Button(root,bd=0, text=" 4 - Delete Doctor",width=25, font=button_font, bg="#b89421", fg="white", padx=10, pady=5, command=self.method4)
#         button4.pack(pady=10)

#         root.mainloop()

#     def method1(self):
#         self.admin.get_doctor_details()
...
# # Create buttons with modern design and colors
#         button1 = tk.Button(self.rroot,bd=0, text=" 1- First name",width=25, font=button_font, bg="#b89421", fg="white", padx=10, pady=5, command=self.update_first_name)
#         button1.pack(pady=10)

#         button2 = tk.Button(self.rroot,bd=0, text=" 2- Surname",width=25, font=button_font, bg="#b89421", fg="white", padx=10, pady=5, command=self.update_surname)
#         button2.pack(pady=10)

#         button3 = tk.Button(self.rroot,bd=0, text=" 3- Speciality",width=25, font=button_font, bg="#b89421", fg="white", padx=10, pady=5, command=self.update_speciality)
#         button3.pack(pady=10)
...
# # Create buttons with modern design and colors
#         button1 = tk.Button(root,bd=0, text="Admin name",width=25, font=button_font, bg="#b89421", fg="white", padx=10, pady=5, command=self.update_admin_name)
#         button1.pack(pady=10)

#         button2 = tk.Button(root,bd=0, text="Admin password",width=25, font=button_font, bg="#b89421", fg="white", padx=10, pady=5, command=self.update_admin_password)
#         button2.pack(pady=10)

#         button3 = tk.Button(root,bd=0, text="Admin address",width=25, font=button_font, bg="#b89421", fg="white", padx=10, pady=5, command=self.update_admin_address)
#         button3.pack(pady=10)
